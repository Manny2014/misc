// Twilio Credentials 
var accountSid = 'ACca46f8ab16e0ddaf8d85e6204e80322q';
var authToken = 'c699bf75663a8bd75edf7fa841c561dq';
var fromNumber = '12222222222';
 ...
 */
function onIntent(intentRequest, sseession, callback) {
    ...
    if("SendSms" === intentName){
        ...
        var number;
        if("roommates" === destination){
            number = "9999999999"
        } else if ("nick" === destination){
            number = "9999999999";
        }
